        ...
        <div className="relative h-64 md:h-80 w-full">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
                ...
                <p className="mt-4 max-w-3xl text-lg text-slate-200">
                    If you have questions or are ready to enroll, please don't hesitate to reach out to me.
                </p>
            </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="bg-secondary/30 p-6 sm:p-8 rounded-lg shadow-lg flex flex-col justify-center">
                    <h2 className="text-3xl font-bold mb-6 text-center lg:text-left">My Contact Information</h2>
                    <div className="space-y-6 text-lg">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold">My Email</h3>
